...
cd /home/ubuntu/PLANK/docker/openssl || { echo "Échec du déplacement dans le répertoire openssl"; exit 1; }
...
cd /home/ubuntu/PLANK/docker/gitlab || { echo "Échec du déplacement dans le répertoire gitlab"; exit 1; }
